...
String telefono1="638562222";
String telefono2="670391657";
String telefono3="696357437";
String telefono4="644495456";
String telefono5="608814731";
String telefono6="644045619";
String telefono7="675560283";
String telefono8="649212224";
...
void enter_pin()
{
  ...
  sendATCommand("AT+CPIN=7672");  //Comando AT para introducir el PIN de la tarjeta
  sendATCommand("AT+CPIN?");
